								...
								<form id="form-validation" action="page_forms_validation.php"
									...
									<fieldset>
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_parkinglot">Parking
												Lot <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<select id="val_parkinglot" name="val_parkinglot" class="form-control">
										...
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_photo_upload">Upload Photo
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_photo_name"
														...
														class="input-group-addon"><i class="fa fa-font"></i></span>
												</div>
											</div>
										</div>
										<div class="form-group">
