...
<title>PTT Edit_FAQ_Category</title>
						...
						<div class="col-md-12">
							<div class="block">
								...
								<c:forEach items="${sessionScope.faqCategoryList}" var="i">
								  <form action="${pageContext.request.contextPath}/FaqCategoryController"
									method="get" class="form-horizontal form-bordered">
									
							<input type="hidden" name="flag" value="updateFaqCategory" />
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" id="val_category"
														...
														placeholder="Enter the Category" value="${i.val_category}"> <span
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea id="val_description" name="val_description" rows="6"
													class="form-control" placeholder="Enter the Description for the Category">${i.val_description}</textarea>
											</div>
										</div>
									</fieldset>
