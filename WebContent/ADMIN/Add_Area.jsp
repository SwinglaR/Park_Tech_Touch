...
<script>
  function loadcity()
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4) 
			{
				...
				for(i=0 ; i<jsonObj.length ; i++)
				{
					...
					document.areaForm.val_cityname.options.add(createOption);
	...
	{
		var removeCity=document.areaForm.val_cityname.options.length;
		for(i=removeCity ; i>0 ; i-- )
		{
			document.areaForm.val_cityname.remove(i);
		}
	}
		...
		<div id="page-container"
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<li>Manage Area</a></li>
						<li><a href="Add_Area.jsp">Add Area</a></li>
					</ul>
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<form id="form-validation" action="${pageContext.request.contextPath }/AreaController"
									method="post" class="form-horizontal form-bordered" name="areaForm">
									...
									<fieldset>
										<div class="form-group">
											...
											<div class="col-md-6">
												<select id="val_statename" name="val_statename" class="form-control" onchange="loadcity()" >
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_areaname" name="val_areaname"
														class="form-control" placeholder="Enter AreaName..">
