...
<title>PTT Search Booking</title>
				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage Booking<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li><a href="Search_booking.jsp">Search Booking</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> Booking
							</h2>
						</div>
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<thead>
									<tr>
										<th class="text-center">Lot_Id</th>
										<th>Booking_ID</th>
										<th>Parking lot_ID</th>
										<th>Parking slot_ID</th>
										<th>User_ID</th>
										<th>Vehicle type_ID</th>
										<th>No of hours</th>
										<th>Time</th>
