				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage City<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li>Manage City</li>
						<li><a href="Search_city.jsp">Search City</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> City
							</h2>
						</div>
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<c:forEach items="${sessionScope.cityList}" var="i">
									<tr>
										<td class="text-center">${i.city_id}</td>
										<td class="text-center">${i.val_cityname }</td>
										<td class="text-center">
											<div class="btn-group">
												<a href="<%=request.getContextPath() %>/CityController?flag=editCity&id=${i.city_id}" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default"><i class="fa fa-pencil"></i></a> 
												<a href="<%=request.getContextPath() %>/CityController?flag=deleteCity&id=${i.city_id}" data-toggle="tooltip" title="Delete"class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
											</div>
										</td>
									</tr>
									</c:forEach>
