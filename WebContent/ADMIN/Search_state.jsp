					...
					<div class="block full">
						...
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<thead>
									<tr>
										<th class="text-center">State_ID</th>
										<th class="text-center">State_name</th>
								...
								<tr>
										<td class="text-center">${i.state_id}</td>
										<td class="text-center">${i.val_statename }</td>
										<td class="text-center">
											<div class="btn-group">
												<a href="<%=request.getContextPath() %>/StateController?id=${i.state_id}&flag=editState" data-toggle="tooltip"
													title="Edit" class="btn btn-xs btn-default"><i
													class="fa fa-pencil"></i></a>
													 <a href="<%=request.getContextPath() %>/StateController?id=${i.state_id}&flag=deleteState" data-toggle="tooltip" title="Delete" class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
											</div>
										</td>
								</tr>
									</c:forEach>
