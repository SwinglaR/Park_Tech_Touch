...
<title>PTT Search Complain</title>
				...
				<div id="page-content" style="min-height: 800px">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage Complain<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li><a href="Search_complain.jsp">Search Complain</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> Complain
							</h2>
						</div>
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<thead>
									<tr>
										<th class="text-center">Complain_ID</th>
										<th>Parking lot_ID</th>
										<th>User_ID</th>
										<th>Complain_message</th>
