...
<title>PTT Add Type of Vehicle</title>
			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<ul class="breadcrumb breadcrumb-top">
						...
						<li>Manage Type of Vehicle</li>
						<li><a href="Add_TypeofVehicle.jsp">Add Type of Vehicle</a></li>
					</ul>
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								<div class="block-title">
									<h2>
										<strong>Add Type of Vehicle</strong> 
									</h2>
								</div>
								<form id="form-validation" action="page_forms_validation.php"
									...
									<fieldset>
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_plotname1">Parking Lot 
												Name <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<select id="val_plotname1" name="val_plotname1" class="form-control">
													<option value="">Please select</option>
												</select>
											</div>
										</div>
									<div class="form-group">
											<label class="col-md-4 control-label" for="val_vehicletype">
												Type Of Vehicle <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<select id="val_vehicletype" name="val_vehicletype" class="form-control">
													<option value="">Please select</option>
												</select>
											</div>
										</div>
