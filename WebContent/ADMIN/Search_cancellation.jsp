...
<title>PTT Search Cancellation</title>
				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage Cancellation<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						<li>Park Tech Touch</li>
						<li>Manage Cancellation</li>
						<li><a href="Search_cancellation.jsp">Search Cancellation</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> Cancellation
							</h2>
						</div>
