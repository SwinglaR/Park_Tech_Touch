					...
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<!-- form-validation -->
								<form id="form-validation" action="${pageContext.request.contextPath}/CityController"
									method="post" class="form-horizontal form-bordered">
									<fieldset>
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_statename1">State 
												Name <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<select id="val_statename" name="val_statename" class="form-control" required="required">
