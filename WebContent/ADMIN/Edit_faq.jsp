			...
			<div id="main-container">
				...
				<div id="page-content">
					...
					<ul class="breadcrumb breadcrumb-top">
						...
						<li>Manage FAQs</li>
						<li><a href="Add_FAQs.jsp">Add FAQs</a></li>
					</ul>
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<form action="${pageContext.request.contextPath}/FaqController"
									method="get" class="form-horizontal form-bordered">
									<c:forEach items="${sessionScope.faqList}" var="i">
									<input type="hidden" name="flag" value="updateFaq" />
									<input type="hidden" name="faq_id" value="${i.faq_id}" />
									
									<fieldset>
									<div class="form-group">
											<label class="col-md-4 control-label" for="val_category"> Category
												<span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
											<select  name="val_category" id="val_category" class="form-control">
											<option>Choose One</option>
											<c:forEach items="${sessionScope.faqCategoryList}" var="x">
											<c:if test="${x.category_id eq i.faqCategoryVO.category_id }">
													<option value="${x.category_id}" selected="selected">${x.val_category}</option>
											</c:if>
											<c:if test="${x.category_id ne i.faqCategoryVO.category_id }">
													<option value="${x.category_id}">${x.val_category}</option>
											</c:if>
													</c:forEach>
											</select>
												</div>
										...
										<div class="form-group">
											<label class="col-md-4 control-label"
												for="val_question">Question
												<span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<div class="input-group">
												
													<input type="text" id="val_question"
														name="val_question" class="form-control"
														placeholder="Enter the Question" value="${i.val_question}"> <span
														class="input-group-addon"><i class="fa fa-fa fa-question"></i></span>
												</div>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_answer">
												Answer <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<textarea id="val_answer" name="val_answer" rows="6"
													class="form-control" placeholder="Enter the Answer for the Question">${i.val_answer}</textarea>
											</div>
										</div>
									</fieldset>
