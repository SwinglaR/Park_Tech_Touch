					...
					<ul class="breadcrumb breadcrumb-top">
						...
						<div class="col-md-12">
							<div class="block">
								...
								<form id="form-validation" action="${pageContext.request.contextPath }/StateController?flag=updateState"
									method="post" class="form-horizontal form-bordered">
						<fieldset>
									<a:forEach items="${sessionScope.editList}" var="i">
									<input type="hidden" name="flag" value="updateState">
									<input type="hidden" name="state_id" value="${i.state_id }">	
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_statename">State Name
											...
											<div class="col-md-6">
												<div class="input-group">
													...
													<input type="text" id="val_statename" name="val_statename"
														class="form-control" value="${i.val_statename}" placeholder="Enter State Name..">
