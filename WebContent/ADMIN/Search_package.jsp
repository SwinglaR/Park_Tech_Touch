...
<title>PTT Search Package</title>
							...
							<table id="example-datatable"
								...
								<thead>
									<tr>
										...
										<th class="text-center">Charges per hour</th>
										<th class="text-center">Actions</th>
									</tr>
								</thead>
								<tbody>
								    <c:if test="${sessionScope.PackageParkingProvider ne null}">
									<c:forEach items="${sessionScope.PackageParkingProvider}" var="i">
									<tr>
										<c:forEach items="${sessionScope.lotList}" var="x">
												 	<c:choose>
													<c:when test="${x.parkinglots_id eq i.parkinglotsVO.parkinglots_id}">
										...
										<td class="text-center">${i.package_id}</td>
										<td class="text-center">${i.val_package_name}</td>
										<td class="text-center">${i.val_package_description}</td>
										<td class="text-center">${i.val_package_price}</td>
										<td class="text-center">${i.val_package_duration}</td>
										<td class="text-center">${i.val_package_hour}</td>
										<td class="text-center">${i.val_package_charge}</td>
										
										<td class="text-center"><div class="btn-group">
												<a href="<%=request.getContextPath()%>/PackageController?package_id=${i.package_id}&flag=editPackage" data-toggle="tooltip"
													title="Edit" class="btn btn-xs btn-default"><i
													class="fa fa-pencil"></i></a> <a href="<%=request.getContextPath()%>/PackageController?package_id=${i.package_id}&flag=deletePackage"
									...
									<c:if test="${sessionScope.PackageParkingProvider eq null}">
									<c:forEach items="${sessionScope.packageList}" var="j">
									<tr>
										<c:forEach items="${sessionScope.lotList}" var="x">
												 	<c:choose>
													<c:when test="${x.parkinglots_id eq j.parkinglotsVO.parkinglots_id}">
														<td class="text-center">${x.val_plotname2}</td>
													</c:when>
													</c:choose>
										...
										<td class="text-center">${j.package_id}</td>
										<td class="text-center">${j.val_package_name}</td>
										<td class="text-center">${j.val_package_description}</td>
										<td class="text-center">${j.val_package_price}</td>
										<td class="text-center">${j.val_package_duration}</td>
										<td class="text-center">${j.val_package_hour}</td>
										<td class="text-center">${j.val_package_charge}</td>
										<td class="text-center"><div class="btn-group">
												<a href="<%=request.getContextPath()%>/PackageController?package_id=${j.package_id}&flag=editPackage" data-toggle="tooltip"
													title="Edit" class="btn btn-xs btn-default"><i
													class="fa fa-pencil"></i></a> <a href="<%=request.getContextPath()%>/PackageController?package_id=${j.package_id}&flag=deletePackage"
													data-toggle="tooltip" title="Delete"
													class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
											</div>
										</td>
