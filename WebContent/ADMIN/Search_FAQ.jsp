				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage FAQs<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li>Manage FAQs </li>
						<li><a href="Search_FAQ.jsp">Search FAQs</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> FAQ
							</h2>
						</div>
						<div class="table-responsive">
							...
							<div style="color:red"><b>${sessionScope.errorMsg}</b></div>
								<thead>
									<tr>
										<th class="text-center">FAQ_ID</th>
								...
								<c:forEach items="${sessionScope.faqList}" var="i">
                                       ...
                                       <tr>
										<td class="text-center">${i.faq_id}</td>
										<td class="text-center">${i.val_question}</td>
										<td class="text-center">${i.val_answer}</td>
									<!--  	<td><a href="javascript:void(0)"></a></td> -->
										
										
										<td class="text-center">
											<div class="btn-group">
												<a href="<%=request.getContextPath()%>/FaqController?faq_id=${i.faq_id}&flag=editFaq" data-toggle="tooltip"
													title="Edit" class="btn btn-xs btn-default"><i
													class="fa fa-pencil"></i></a> <a href="<%=request.getContextPath()%>/FaqController?faq_id=${i.faq_id}&flag=deleteFaq"
