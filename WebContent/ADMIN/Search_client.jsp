					...
					<div class="block full">
						...
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<tbody>
								<c:forEach items="${sessionScope.clientList}" var="i">     
								<tr>
										<td class="text-center">${i.client_id}</td>
										<td class="text-center">${i.client_first_name}</td>
										<td class="text-center">${i.client_last_name}</td>
										<td class="text-center">${i.client_mobile_number}</td>
