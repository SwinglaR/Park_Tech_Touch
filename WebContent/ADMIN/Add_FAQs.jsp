					...
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<form id="form-validation" action="${pageContext.request.contextPath }/FaqController"
									method="post" class="form-horizontal form-bordered">
									<input type="hidden" name="flag" value="insertFaq">
									<fieldset>
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_question"
														...
														placeholder="Enter the Question"> <span
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea id="val_answer" name="val_answer" rows="6"
													class="form-control" placeholder="Enter the Answer for the Question"></textarea>
											</div>
										</div>
									</fieldset>
