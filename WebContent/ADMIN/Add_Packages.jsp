					...
					<div class="row">
						<div class="col-md-12">
							<div class="block">
								...
								<form id="form-validation" action="${pageContext.request.contextPath}/PackageController"
									method="post" class="form-horizontal form-bordered">
									<input type="hidden" name="flag" value="insertPackage">
									<fieldset>
										<div class="form-group">
											<label class="col-md-4 control-label" for="val_plotname2">Parking lot 
												Name <span class="text-danger">*</span>
											</label>
											<div class="col-md-6">
												<select id="val_plotname2" name="val_plotname2" class="form-control" >
													<option value="">Chooose One</option>
													<c:if test="${sessionScope.lotListParkingProvider ne null}">
													<c:forEach items="${sessionScope.lotListParkingProvider}" var="x">
													<option value="${x.parkinglots_id}">${x.val_plotname2}</option>
													</c:forEach>
													</c:if>
													<c:if test="${sessionScope.lotListParkingProvider eq null}">
													<c:forEach items="${sessionScope.lotList}" var="j">
													<option value="${j.parkinglots_id}">${j.val_plotname2}</option>
													</c:forEach>
													</c:if>					
												</select>
											</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_package_name"
														...
														placeholder="Enter name for the Package"> <span
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<textarea id="val_package_description" name="val_package_description" rows="6"
													class="form-control" placeholder="Enter Description for the Package"></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-4 control-label"
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_package_price"
														...
														placeholder="Enter price for the Package"> <span
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_package_duration"
														...
														placeholder="Enter duration for the Package"> <span
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_package_hour"
														...
														placeholder="Enter the number of hours"> <span
														class="input-group-addon"><i class="fa fa-clock-o"></i></span>
												</div>
											</div>
										</div>
											...
											<div class="col-md-6">
												<div class="input-group">
													<input type="text" id="val_package_charge"
														...
														placeholder="Enter the charges per hour"> <span
														class="input-group-addon"><i class="fa fa-money"></i></span>
												</div>
											</div>
										</div>
