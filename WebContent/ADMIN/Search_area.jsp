				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Manage Area<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li>Manage Area</li>
						<li><a href="Search_area.jsp">Search Area</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Search</strong> Area
							</h2>
						</div>
							...
							<table id="example-datatable"
								...
								<thead>
									<tr>
										...
										<th class="text-center">Area_name</th>
								...
								<tr>
										<td class="text-center">${i.area_id}</td>
										<td class="text-center">${i.val_areaname }</td>
										<td class="text-center">
											<div class="btn-group">
												<a href="<%=request.getContextPath() %>/AreaController?id=${i.area_id}&flag=editArea" data-toggle="tooltip"
													title="Edit" class="btn btn-xs btn-default"><i
													class="fa fa-pencil"></i></a> <a href="<%=request.getContextPath() %>/AreaController?id=${i.area_id}&flag=deleteArea"
