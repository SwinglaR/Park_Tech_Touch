				...
				<div id="page-content">
					<div class="content-header">
						<div class="header-section">
							<h1>
								<i class="fa fa-table"></i>Continuous Period Booking<br>
							</h1>
						</div>
					</div>
					<ul class="breadcrumb breadcrumb-top">
						...
						<li><a href="SearchContinuous.jsp">Continuous Period Booking</a></li>
					</ul>
					<div class="block full">
						<div class="block-title">
							<h2>
								<strong>Continuous Period</strong> Booking
							</h2>
						</div>
						<div class="table-responsive">
							<table id="example-datatable"
								...
								<tbody>
								<c:if test="${sessionScope.continuousListProvider ne null}">
								<c:forEach items="${sessionScope.continuousListProvider}" var="i">
										
									<tr>
										<td class="text-center">${i.bookingContinuousPeriod_id}</td>
										...
										<div class="btn-group">
										<a href="<%=request.getContextPath() %>/BookParkingSlotsController?flag=deleteContiBooking&id=${i.bookingContinuousPeriod_id}" data-toggle="tooltip" title="Delete"class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										</div>
									...
									<c:if test="${sessionScope.continuousListProvider eq null}">
									<c:forEach items="${sessionScope.continuousList}" var="j">
										
									<tr>
										<td class="text-center">${j.bookingContinuousPeriod_id}</td>
										...
										<td class="text-center">${j.end_date}</td>
										...
										<td class="text-center">
										<div class="btn-group">
										<a href="<%=request.getContextPath() %>/BookParkingSlotsController?flag=deleteContiBooking&id=${j.bookingContinuousPeriod_id}" data-toggle="tooltip" title="Delete"class="btn btn-xs btn-danger"><i class="fa fa-times"></i></a>
										</div>
