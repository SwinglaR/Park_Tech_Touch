...
<html class="no-js" lang="en">
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# parkatmyhouse: http://ogp.me/ns/fb/parkatmyhouse#">
        ...
        <title>Password reset request | JustPark</title>
...
(function(d, debug){
     ...
     ref.parentNode.insertBefore(js, ref);
        ...
        <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">Ã—</button>Password reset request<i class="icon-lock"></i></div>
<div class="modal-body">

<p>Please enter your registered JustPark email address below and we'll send you instructions on how to reset your password.</p>
<form action="/password/reset/" method="post" accept-charset="utf-8" class="form-horizontal">

                <div class="form-group control-group required">
                    <label for="id_email" class="sr-only control-label">Email address</label>
                    <div class="controls">
                        <input value="" type="email" class="phorm_field_email" id="id_email" name="email" />
