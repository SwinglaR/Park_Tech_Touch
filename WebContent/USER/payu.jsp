...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
          ...
          <td><input name="amount" value="${sessionScope.Amount1}" /></td>
          </c:if>
          <c:if test="${sessionScope.Amount1 eq null}">
          <td><input name="amount" value="${sessionScope.Amount}" /></td>
          </c:if>
          
          <td>First Name: </td>
          <td><input name="firstname" id="firstname" value="${sessionScope.clientName}" /></td>
        </tr>
        <tr>
          <td>Email: </td>
          <td><input name="email" id="email" value="${sessionScope.userName}" /></td>
          <td>Phone: </td>
          <td><input name="phone" value="${sessionScope.number}" /></td>
        </tr>
        <tr>
          <td>Product Info: </td>
          <td colspan="3"><input name="productinfo" value="Parking" size="64" /></td>
        </tr>
        <tr>
          <td>Success URI: </td>
          <td colspan="3"><input name="surl" value="index_user.jsp" size="64" /></td>
        </tr>
        <tr>
          <td>Failure URI: </td>
          <td colspan="3"><input name="furl" value="login.jsp" size="64" /></td>
        </tr>
        <tr>
