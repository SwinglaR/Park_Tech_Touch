  ...
  <div class="external-logins">
	...
	<div class="email-signup hidden">
		...
		<div class="control-group required ">
			...
			<div class="controls">
				<input value="" class="input-smedium phorm_field_name" placeholder="First name" id="id_first_name" name="first_name" type="text" />				
				<input value="" class="input-smedium phorm_field_name" placeholder="Last name" id="id_last_name" name="last_name" type="text" />											
			</div>
		</div>
         ...
         <div class="form-group control-group required">
            <label for="id_email" class="sr-only control-label">Email address</label>
              <div class="controls">
                 <input value="" type="email" class="phorm_field_email has-tooltip" title="If possible, please use your personal email address" id="id_email" name="email" />        
              </div>
         </div>
                ...
                <div class="form-group control-group required">
                    ...
                    <div class="controls">
                        <input value="" minlength="6" class="phorm_field_password" id="id_password" name="password" type="password" />
 				...
 				<div class="form-group control-group required">
                    ...
                    <div class="controls">
                        <input value="" minlength="6" class="phorm_field_password" id="id_confirmpassword" name="confirmpassword" type="password" />
...
<option  value="Other" >(Other)</option>
            	...
            	-->	
                <div class="form-group control-group">
                    <label for="id_mobile_number" class="sr-only control-label"><strong>Mobile Number</strong></label>
                    <div class="controls">
                        <input value="" class="phorm_field_text" id="id_mobile_number" name="mobile_number" type="text" />
