...
<html class="no-js" lang="en">
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# parkatmyhouse: http://ogp.me/ns/fb/parkatmyhouse#">
        ...
        <meta name="description" content="An introduction to how JustPark was founded, information about the members of our team and details on how to make the most from our unique service." />
...
href="css/static-overrides.css" />
    ...
    <body lang="en" class="about static country-gb">
    <!-- Google Tag Manager -->
...
<!-- <div class="about-header">
  <h1 class="central-title">About JustPark</h1>
  <div class="central-separator"></div>
</div>  -->

    <h2 id="what-is-justpark">What is Park Tech Touch?</h2>
    <p>ParkTechTouch is pre-bookable parking. The idea
    is brutally simple: we connect users in search of parking with parking provider who
    has a space going spare, whether in a car park, malls,parkinglots,stadiums,hotels,restaurants,
    railway stations,airports.</p>
    <p>Every car journey begins and ends with a parking space. And we believe in
    happy endings. The ParkTechTouch platform lets you browse, book and pay for a
    space that suits you down to the ground, without having to rely on the
    goodwill of the Parking Fairy. Users are finally able to take charge of
    the process from A to Z and make their way from A to B, hassle-free.</p>
