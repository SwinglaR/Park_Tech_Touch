...
<td><input type="hidden" name="parkingLot" value="${i.val_plotname2}" />${i.val_plotname2}</td>
...
<input type="hidden" name="s_date" value="${j.start_date } "/>
				...
				<c:set var="startingDate" value="${j.start_date }" scope="session"></c:set>
							${j.start_date } 
