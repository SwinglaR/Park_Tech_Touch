        ...
        <script>
         ...
         function loginErrorMessage()
         {
        	...
        	xmlhttp.onreadystatechange = function() {
        	 ...
        	 xmlhttp.open("get", "${pageContext.request.contextPath}/ClientController?flag=loginErrorMessage&email="+email.value, true);
        	 xmlhttp.send();
         }
        </script>
        <script>
...
<input type="hidden" name="flag" value="insertClient"/>
...
<!-- 
  <div class="external-logins">
	...
	<p id="reveal-email-signup"  style="color:#aaa; text-align:center;"><a href="registrationClient.jsp">Sign up with your email address</a></p>
