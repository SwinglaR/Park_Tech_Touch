...
<html class="no-js" lang="en">
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# parkatmyhouse: http://ogp.me/ns/fb/parkatmyhouse#">
        ...
        <title>Cancellation policy Park Tech Touch </title>
        ...
        <meta property="og:image" content="http://www.justpark.com/media/img/logos/320-colour.png" />
        <meta property="og:image:secure_url" content="https://www.justpark.com/media/img/logos/320-colour.png" />
        ...
        <meta name="twitter:image:src" content="https://www.justpark.com/media/img/logos/56-colour.png">
        ...
        <link rel="apple-touch-icon" sizes="72x72" href="/media/img/assets/iphone/icons/72x72.png" />
        <!-- For non-Retina iPhone, iPod Touch, and Android 2.1+ devices: -->
        <link rel="apple-touch-icon" href="/media/img/assets/iphone/icons/57x57.png" />
        ...
        <!-- Google Analytics -->
        <script src="js/bugsnag-2.min.js"
data-apikey="18f2e5ddb745842bb36117517e83d1a4"></script>
...
href="css/static-overrides.css" />
    </head>
    <body lang="en" class="static country-gb">
    <!-- Google Tag Manager -->
     ...
     ref.parentNode.insertBefore(js, ref);
        ...
        <div id="wrapper">
            ...
            <div class="span3" id="left-sidebar">
                <ul class="nav nav-list nav-static">
  <li class="nav-header">About</li>
  <li><a href="/about/">About JustPark</a></li>  <li><a href="/press/media-coverage/">Media coverage</a></li>  <li><a href="/jobs/">Jobs</a></li>
  <li class="nav-header">How it works</li>
  <li><a href="/how-it-works/find-parking/">Drivers</a></li>  <li><a href="/how-it-works/rent-out-my-parking-space/">Space Owners</a></li>  <li><a href="https://www.justpark.com/work-with-us/hotels">Hotels</a></li>  <li><a href="https://www.justpark.com/work-with-us/carparks">Car parks</a></li>  <li><a href="https://www.justpark.com/work-with-us/community-spaces">Community spaces</a></li>  <li><a href="/how-it-works/driver-protection-guarantee/">Driver protection guarantee</a></li>  <li><a href="/how-it-works/reviews-and-feedback/">Reviews & feedback</a></li>  <li><a href="https://help.justpark.com/forums">FAQ</a></li>  <li><a href="/community/work-with-us/">Work with us</a></li>
  <li class="nav-header">Resources</li>
  <li><a href="/resources/">Resources</a></li>  <li><a href="/press/">Media Centre</a></li>
  <li class="nav-header">Policies &amp; agreements</li>
  <li class="active"><a href="/cancellation-policy/">Cancellation policy</a></li>  <li><a href="/driver-agreement/">Driver agreement</a></li>  <li><a href="/owner-agreement/">Owner agreement</a></li>  <li><a href="/parking-space-license-agreement/">Rental agreement</a></li>  <li><a href="/reviews-and-feedback-policy/">Reviews &amp; Feedback</a></li></ul>
            </div>
...
<p>We have one cancellation policy at JustPark. If a driver cancels, the amount
we can refund depends on two things: the length of the booking, and when the
driver makes the cancellation request.</p>

<h5 class="double-spacing">If the space owner cancels, the driver will always receive a full
  refund.</h5>

<div class="clearfix spacing">
  <div class="m-4 m-bordered-column">
    <h3 class="no-spacing">Short-term booking</h3>
    <p>One day or less</p>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
      <div class="block__text">
        <p class="block__text">Before booking starts:</p>
        <p class="block__text block__text--success">Full refund</p>
      </div>
    </div>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
      <div class="block__text">
        <p class="block__text">After booking starts:</p>
        <p class="block__text block__text--error">No refund</p>
      </div>
    </div>
  </div>
  <div class="m-4 m-bordered-column">
    <h3 class="no-spacing">Medium-term booking</h3>
    <p>2-7 days</p>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
      <div class="block__text">
        <p class="block__text">Before booking starts:</p>
        <p class="block__text block__text--success">Refund minus 1 day</p>
      </div>
    </div>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
      <div class="block__text">
        <p class="block__text">After booking starts:</p>
        <p class="block__text block__text--error">Refund for remainder of booking
        minus 1 day</p>
      </div>
    </div>
  </div>
  <div class="m-4 m-bordered-column">
    <h3 class="no-spacing">Long-term booking</h3>
    <p>8+ days</p>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
      <div class="block__text">
        <p class="block__text">Before booking starts:</p>
        <p class="block__text block__text--success">Refund minus 2 days</p>
      </div>
    </div>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-vehicle-small"></span>
...
<h2 class="spacing">The rules</h2>

<div class="clearfix spacing">
  <div class="m-6">
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-stopwatch"></span>
      <p class="block__text">Complaints must be raised with JustPark within 24
      hours after the booking starts.</p>
    </div>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-thumbsup"></span>
      <p class="block__text">A booking is officially cancelled once we approve
      the cancellation.</p>
    </div>
  </div>
  ...
  <div class="m-6">
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-policeman"></span>
      <p class="block__text">JustPark will mediate when necessary and has the
      final say in all disputes.</p>
    </div>
    <div class="block clearfix">
      <span class="block__icon focus-icons jp-badge"></span>
      <p class="block__text">You'll always benefit from our
        <a href="/how-it-works/driver-protection-guarantee/">
          Driver Protection Guarantee
        </a> and
        <a href="/parking-space-license-agreement/">Rental Agreement</a>.
      </p>
    </div>
  </div>
</div>

<h3 class="spacing">What constitutes a JustPark day?</h3>
<div class="block clearfix">
  <p>Our 'days' are calculated by a calendar day that resets at 5am. We do this to account for drivers who might be parking for evening events.</p>
  <p>If your booking extends beyond 5am, you will be charged for two days, even if the booking spans less than 24 hours.</p>
  <p>For example:</p>
  <ul>
    <li>7.00pm 1st January - 2.00am 2nd January = one day.</li>
    <li>7.00pm 1st January - 8.00am 2nd January = two days.</li>
  </ul>
</div>
  ...
  (function() {
    ...
    if (window.JP) {
      ...
      return;
        ...
        <script src="js/static-overrides.js"></script>
