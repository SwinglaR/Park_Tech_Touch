...
<html class="no-js" lang="en">
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# parkatmyhouse: http://ogp.me/ns/fb/parkatmyhouse#">
        ...
        <title>Password reset request Park Tech Touch</title>
...
(function(d, debug){
     ...
     ref.parentNode.insertBefore(js, ref);
        ...
        <div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">Ã—</button>Password reset request</div>
<div class="modal-body">

<p>Please enter your registered ParkTechTouch email address below and we'll send you instructions on how to reset your password.</p>
...
<input type="hidden" name="flag" value="forgotPassword" />
                <div class="form-group control-group required">
                    ...
                    <div class="controls">
                        <input value="" type="email" class="phorm_field_email" id="id_email" name="email" style="width:250px" />
                        
                    </div>
                    <span><font color="red">${sessionScope.otpSendError}</font></span>
                </div>
                <div id="Msg" style="color:red"></div>
            <div class="modal-footer">    
      
	<button type="submit" class="btn btn-large btn-primary">Send OTP Password</button>
	</form>  
</div>	
