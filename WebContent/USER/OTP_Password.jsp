...
<html class="no-js" lang="en">
    ...
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# parkatmyhouse: http://ogp.me/ns/fb/parkatmyhouse#">
        ...
        <meta name="description" content="Securely log in to your JustPark account" />
...
(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
  ...
  m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
    ...
    ga('set', 'dimension1', 'Anonymous'); // member-type
...
function fnnull()
{
	...
	if(otp_code.value=="")
		{
		Msg.innerHTML="Please enter otp code";
		return false;
		}
...
<script type="text/javascript">
        function errorPassword()
        {
            ...
            <base href="${pageContext.request.contextPath}/USER">
    <body lang="en" class="login country-gb">
    <!-- Google Tag Manager -->
...
(function(d, debug){
     ...
     ref.parentNode.insertBefore(js, ref);
        ...
        <form action="${pageContext.request.contextPath}/ClientController" method="post" accept-charset="utf-8" class="form-horizontal" onsubmit="return fnnull()">
        <input type="hidden" name="flag" value="setNewPassword" />
  ...
  <div class="external-logins">
	...
	<input value="/zendesk/login/?brand_id=3274556&amp;locale_id=1&amp;return_to=https%3A%2F%2Fhelp.justpark.com%2Fhc%2Fen-us&amp;timestamp=1453787580" class="phorm_field_hidden" id="id_next" name="next" type="hidden" />	
                <div class="form-group control-group required">
                    <label for="otp_code" class="sr-only control-label">OTP Code</label>
                    <div class="controls">
                        <input value="" placeholder="OTP Code" class="phorm_field_text" id="otp_code" name="otp_code" type="text" style="width:250px"/>
                ...
                <div class="form-group control-group required">
                    <label for="new_password" class="sr-only control-label">New Password</label>
                    <div class="controls">
                        <input value="" placeholder="New Password" class="phorm_field_password" id="new_password" name="new_password" type="password" style="width:250px"/>
                 ...
                 <div class="form-group control-group required">
                    ...
                    <div class="controls">
                        <input value="" placeholder="Confirm Password" class="phorm_field_password" id="confirm_password" name="confirm_password" type="password"style="width:250px" onblur="errorPassword()"/>
                        <div id="errorPasswordmsg" style="color:red"></div>
                        
                    </div>
                </div>
                <span><font color="red">${sessionScope.otpInvalid}</font></span>
                <div id="Msg" style="color:red"></div>
            	<!-- <p id="signup-now">Don't have an account? <a class="em" href="">Sign up now &rarr;</a></p> -->
</div>
<div class="modal-footer">
	<button type="submit" class="btn btn-large btn-primary">Update Password</button>
        ...
        <!-- End of wrapper -->
                    <%@include file="footer.jsp" %>            <div id="pamh_modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true"><div class="modal-content"></div></div>
...
<script type="text/javascript">
	...
	c.parentNode.insertBefore(s, c);
            ...
            <script type="text/javascript" src="js/core.min1.js?v=1453551567"></script>
            <script>
  (function() {
